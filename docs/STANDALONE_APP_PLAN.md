...
2. Move the current control panel into a desktop shell.
3. Add settings for API keys, NetSuite browser behavior, and voice provider.
4. Add update checking against GitHub Releases.
5. Add signed Mac and Windows builds.
6. Add a GitHub Actions release workflow.
7. Publish the first release to `NSDemoHelper`.
